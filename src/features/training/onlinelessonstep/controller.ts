...
const entity = {
  model: 'OnlineLessonStep' as keyof PrismaClient,
  name: 'Onlinelessonstep',
  route: 'online-lesson-step',
  permission: 'treinamentos',
};

@Controller(entity.route)
export class OnlinelessonstepController extends GenericController<
  CreateDto,
  UpdateDto,
  IEntity,
  Service
> {
  ...
  // @Cache({ prefix: 'online-lesson-step', ttl: 3600 }) // descomente para usar cache (1 hora)
  @Get()
